...
# %% [markdown]
# ## 5. Create anomaly-detection features
...
dataset = model_df[["Timestamp", "Status"] + feature_cols].dropna().copy()
...
anomaly_rows[["Timestamp", "Status", "CycleTime_sec", "RejectCount", "AnomalyScore"]].head(15)
...
# - tune `contamination` and feature set
